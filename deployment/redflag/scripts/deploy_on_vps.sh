...
SOKETI_BIND_PORT="${SOKETI_BIND_PORT:-18104}"
...
SOKETI_DOMAIN="${SOKETI_DOMAIN:?SOKETI_DOMAIN is required}"
...
SOKETI_DOMAIN="$(validate_site_address "SOKETI_DOMAIN" "${SOKETI_DOMAIN}")"
...
SOKETI_BIND_PORT=${SOKETI_BIND_PORT}
...
${SOKETI_DOMAIN} {
  encode zstd gzip
  reverse_proxy 127.0.0.1:${SOKETI_BIND_PORT}
}
EOF
